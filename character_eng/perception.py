...
def process_perception(event: PerceptionEvent, people, world) -> tuple[None, str]:
    """Queue a perception event for reconciliation. Returns (None, narrator_message).

    Person matching is deferred to the reconciler LLM — we just add the
    description as a pending world change.
    """
