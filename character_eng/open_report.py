    ...
    personas = [
        PersonaResult(
            ...
            boot_log=[{
                "type": "plan",
                "beats": 3,
                "intents": ["Greet customer", "Offer a flier", "Ask what brings them here"],
            }],
            turns=[
                TurnRecord(turn=0, action="message", input_text="Hey, what's up?",
                           response="Not much — just sitting here at my stand, hoping someone takes a flier. Story of my life."),
                TurnRecord(turn=1, action="message", input_text="What's on the flier?",
                           response="It's got a coupon for a free cup of water. Pretty good deal if you ask me.",
                           eval_entry={"thought": "They seem interested in the fliers", "gaze": "customer",
                                       "expression": "curious", "script_status": "advance"}),
                TurnRecord(turn=2, action="world", input_text="A gust of wind blows fliers off the table",
                           response="No no no! The fliers! Could you grab those for me? I would but, you know, no hands."),
                TurnRecord(turn=3, action="message", input_text="I got them!",
                           response="You're a lifesaver. Seriously. What do I owe you?",
                           eval_entry={"thought": "That was close, glad they helped", "gaze": "customer",
                                       "expression": "excited", "script_status": "off_book",
                                       "plan_request": "Thank the helper and get back to handing out fliers"}),
            ],
        ),
        PersonaResult(
            persona=PersonaConfig(
            ...
            boot_log=[{
                "type": "plan",
                "beats": 3,
                "intents": ["Adjust the flier stack", "Lament lack of hands", "Call out to passersby"],
            }],
            turns=[
                TurnRecord(turn=0, action="beat", input_text="",
                           response="These fliers aren't gonna hand themselves out. Well, I can't hand them out either."),
                TurnRecord(turn=1, action="beat", input_text="",
                           response="I wish I had hands so I could wave one of these around.",
                           eval_entry={"thought": "Maybe if I had a body...", "gaze": "stand",
                                       "expression": "wistful", "script_status": "advance"}),
                TurnRecord(turn=2, action="beat", input_text="",
                           response="Hey, is anyone out there? Free water coupon! Just grab a flier!",
                           stale_discard=True),
            ],
        ),
        PersonaResult(
