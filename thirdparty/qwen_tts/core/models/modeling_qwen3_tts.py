    ...
    def forward(
        ...
        **kwargs,
        ...
        # Generate
            ...
            # Streaming support: push codec_ids to streamer
            if audio_streamer is not None:
                audio_streamer.put_audio_codes(codec_ids)
...
class Qwen3TTSForConditionalGeneration(Qwen3TTSPreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        # Pass through any other kwargs (like streamer)
        for k, v in kwargs.items():
            if k not in talker_kwargs:
                talker_kwargs[k] = v
